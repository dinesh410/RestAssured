...
Scenario: Update an existing student & verify if the student is updated 
	When I update an existing student by providing the information firstName, lastName, email, programme and courses 
		| firstName | lastName | email                                        | programme        | courses |
		| Declan    | Smith    | nnon222.ante.bibendum@risusDonecegestas.edu   | Computer Science | Java    |
		| Mark      | Taylor   | nnon234.ante.bibendum@risusDonecegestas.edu    | Computer Science | Java    |		
	Then I verify that the student with email is updated 
		| email |
		| nnon222.ante.bibendum@risusDonecegestas.edu   |
		| nnon234.ante.bibendum@risusDonecegestas.edu   |		
